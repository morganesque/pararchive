...
<div class="container-fluid">
	...
	<div class="page-header"><h1><span class="icon icon-library"></span> An object from an archive?</h1></div>
	...
	<div class="row">
		...
		<div class="col-xs-6">
			<input class="btn btn-lg btn-primary btn-block use__this" type="submit" value="Use This">
		</div>
	</div>
